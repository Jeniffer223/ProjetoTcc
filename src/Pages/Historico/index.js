import { View, Text, StyleSheet, TouchableOpacity, PermissionsAndroid, Platform, Linking, Alert} from 'react-native';
...
export default function HistoricoEscolar({ navigation }) {
  return (
    ...
    const url = 'https://imgv2-2-f.scribdassets.com/img/document/397072126/original/17ccdbcd2b/1?v=1';
